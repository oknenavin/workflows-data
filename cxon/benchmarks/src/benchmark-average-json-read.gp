...
plot INPUT.'.data'   every 17:1:16 using 3 axes x1y1 smooth acsplines with line dt 1 lw 2 lc rgb '#FF8C00' title 'cxon', \
                ...
                ''   every 17:1:16 using 7 axes x1y1 smooth acsplines with line dt 1 lw 2 lc rgb '#DC143C' title 'rapidjson', \
                ''   every 17:1:16 using 8 axes x1y2 smooth acsplines with line dt 3 lw 3 lc rgb '#1E90FF' notitle, \
                ''   every 17:1:16 using 9 axes x1y1 smooth acsplines with line dt 1 lw 2 lc rgb '#1E90FF' title 'nlohmann/json'
