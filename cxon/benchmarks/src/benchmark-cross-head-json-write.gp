...
plot @cc0.'.data'   using 10:xtic(1)    lc rgb '#FF8C00' title 'g++',\
     @cc1.'.data'   using 10            lc rgb '#32CD32' title 'clang++',\
     @cc2.'.data'   using 10            lc rgb '#DC143C' title 'msvc++',\
     @cc3.'.data'   using 10            lc rgb '#1E90FF' title 'xcode'
